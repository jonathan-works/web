!function (a, b) {
    ...
    var g = document.documentElement.style, h = "string" == typeof g.transition ? "transition" : "WebkitTransition",
        ...
        k = [i, h, h + "Duration", h + "Property"], l = e.prototype = Object.create(b.prototype);
    l.constructor = e, l._create = function () {
        ...
        var a = getComputedStyle(this.element), b = this.layout._getOption("originLeft"),
            ...
            f = this.layout.size, g = -1 != d.indexOf("%") ? parseFloat(d) / 100 * f.width : parseInt(d, 10),
...
!function (a) {
    var b = {
        init: function (b) {
            ...
            return this.each(function (c) {
                ...
                var f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F = !0, G = !1,
                    H = !1, I = !0, J = a(this), K = J.attr("id") || c.toString(), L = J.find(".gallery-cover"),
                    M = J.find(".gallery-header"), N = J.find(".gallery-curve-wrapper"), O = J.find(".gallery-body"),
                    P = J.find(".gallery-action"), Q = !!L.length && (a(this).attr("data-fillScreen") || b.fillScreen),
                    R = a(this).hasClass("gallery-horizontal"), S = !1, T = 64, U = ".btn, .btn-large, .btn-floating",
                    V = b.contentPadding, W = "cubic-bezier(0.420, 0.000, 0.580, 1.000)", X = a(document).width(),
                    Y = window.innerHeight, Z = !1;
                ...
                J.off("click.galleryExpand").on("click.galleryExpand", function (c) {
                    ...
                    if (da(), D = g.clone(!0), a("body").css("overflowX", "hidden"), a("body").on("scroll.disable-scroll mousewheel.disable-scroll touchmove.disable-scroll", function (a) {
                        ...
                        Q ? ea += p.left + "px, " + V + "px, 0)" : (L.css({
                            left: A + V,
                            top: V
                        }), ea += p.left - A - V + "px, 0, 0)"), L.css({height: o, width: n, transform: ea})
                    }
                    var fa = p.top - T - V;
                    N.css({
                        display: "block",
                    ...
                    var ha = a('<nav id="placeholder-navbar"></nav>'), ia = a('<div class="nav-wrapper"></div>'),
    ...
    a(function () {
        ...
        a(".gallery-expand").galleryExpand({onShow: e}), a(".blog .gallery-expand").galleryExpand({
            onShow: e,
            fillScreen: !0,
            inDuration: 500
        })
