...
Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity, function (a) {
        ...
        return "open" === b ? (this.each(function () {
            ...
            function e(b) {
                ...
                var c = window.innerHeight, e = g.innerHeight(), k = g.offset().left,
                    l = g.offset().top - a(window).scrollTop(), m = h.alignment, n = 0, o = 0, p = 0;
                h.belowOrigin === !0 && (p = e);
    ...
    var b = 0, c = 0, d = function () {
        ...
        init: function (c) {
            var e = {
                opacity: .5, inDuration: 350, outDuration: 250, ready: void 0,
                complete: void 0, dismissible: !0, startingTop: "4%", endingTop: "10%"
            };
            return c = a.extend(e, c), this.each(function () {
                var e = a(this), f = a(this).attr("id") || "#" + a(this).data("target"), g = function () {
                    ...
                    if (h.css("overflow", "hidden"), h.width(i), !e.hasClass("open")) {
                        ...
                        lStack = ++b, k.attr("id", j).css("z-index", 6), e.data("overlay-id", j).css("z-index", 1e3 + 2 * lStack + 1), e.addClass("open"), a("body").append(k), c.dismissible && (k.click(function () {
                            g()
    ...
    var b = {
        init: function (b) {
            ...
            return b = a.extend(c, b), this.each(function () {
                var c, d, e, f, g, h = a(this), i = a(window).width(), j = h.find("li.tab a"), k = h.width(), l = a(),
                    m = Math.max(k, h[0].scrollWidth) / j.length, n = prev_index = 0, o = !1, p = 300,
                    q = function (a) {
            ...
            f.on({
                "mouseenter.tooltip": function (a) {
                    var c = function () {
                        ...
                        var a, c, e, g = f.outerWidth(), h = f.outerHeight(), j = k.outerHeight(), n = k.outerWidth(),
                            o = "0px", q = "0px", r = l[0].offsetWidth, s = l[0].offsetHeight, t = 8, u = 8, v = 0;
                ...
                b.draggable && (f.on("click", function () {
                    ...
                    if ("touch" == c.gesture.pointerType) {
                        var d = (c.gesture.direction, c.gesture.center.x),
                            f = (c.gesture.center.y, c.gesture.velocityX, a("body")), h = a("#sidenav-overlay"),
                            j = f.innerWidth();
                    ...
                    if ("touch" == c.gesture.pointerType) {
                        var d = a('<div id="sidenav-overlay"></div>'), g = c.gesture.velocityX, j = c.gesture.center.x,
                            k = j - b.menuWidth, l = j - b.menuWidth / 2;
                        k > 0 && (k = 0), l < 0 && (l = 0), h = !1, "left" === b.edge ? i && g <= .3 || g < -.5 ? (0 !== k && e.velocity({translateX: [0, k]}, {
                            duration: 300,
                            queue: !1,
                            easing: "easeOutQuad"
                        }), d.velocity({opacity: 1}, {duration: 50, queue: !1, easing: "easeOutQuad"}), f.css({
                            width: "50%",
                            right: 0,
                            left: ""
    ...
    a(document).ready(function () {
        ...
        a(document).on("change", h, function (b) {
            ...
            return b = a.extend(c, b), this.each(function () {
                var c, d = a(this), e = b.data, f = 0, g = 0, h = d.closest(".input-field");
                if (!a.isEmptyObject(e)) {
                    ...
                    var k = function (a, b) {
                        var c = b.find("img"), d = b.text().toLowerCase().indexOf("" + a.toLowerCase()),
                            e = d + a.length - 1, f = b.text().slice(0, d), g = b.text().slice(d, e + 1),
                            h = b.text().slice(e + 1);
                    ...
                    d.off("keyup.autocomplete").on("keyup.autocomplete", function (g) {
                        if (f = 0, 13 !== g.which && 38 !== g.which && 40 !== g.which) {
                            ...
                            if (c !== h && (j.empty(), l(), "" !== h)) for (var i in e) if (e.hasOwnProperty(i) && i.toLowerCase().indexOf(h) !== -1 && i.toLowerCase() !== h) {
                                if (f >= b.limit) break;
                                var m = a("<li></li>");
    ...
    var b = function (b) {
        ...
        if ("true" !== b.attr("data-open")) {
            var c, d, f, g = window.innerWidth, h = window.innerHeight, i = b[0].getBoundingClientRect(),
                j = b.find("> a").first(), k = b.find("> ul").first(), l = a('<div class="fab-backdrop"></div>'),
        ...
        if ("true" === a.attr("data-open")) {
            var b, c, d, e = window.innerWidth, f = window.innerHeight, g = a.attr("data-origin-width"),
                h = a.attr("data-origin-bottom"), i = a.attr("data-origin-left"), j = a.find("> .btn-floating").first(),
                k = a.find("> ul").first(), l = a.find(".fab-backdrop"), m = j.css("background-color");
    ...
    c.prototype.set = function (a, b, c) {
        ...
        var e, g, h, i, j = this, k = c, l = d && d.interval ? d.interval : 1, m = j.item.enable === -1, n = j.item.min,
            ...
            return b = a.extend(c, b), this.each(function () {
                ...
                function g(c) {
                    ...
                    if (r = "number" == typeof c ? c : r, s = Math.floor((r + u / 2) / u), g = r - s * u, h = g < 0 ? 1 : -1, i = -h * g * 2 / u, e = v >> 1, b.fullWidth ? k = "translateX(0)" : (k = "translateX(" + (J[0].clientWidth - p) / 2 + "px) ", k += "translateY(" + (J[0].clientHeight - q) / 2 + "px)"), K) {
                        var m = s % v, n = I.find(".indicator-item.active");
                ...
                function j(c) {
                    ...
                    if (!b.fullWidth) {
                        var d = a(c.target).closest(".carousel-item").index(), e = s % v - d;
                ...
                function m(a) {
                    var b, c, f;
                    if (t) if (b = d(a), y = e(a), c = w - b, f = Math.abs(x - y), f < 30 && !H) (c > 2 || c < -2) && (G = !0, w = b, g(r + c)); else {
                ...
                var o, p, q, r, s, t, u, v, w, x, z, A, B, C, D, E, F, G, H, I = a('<ul class="indicators"></ul>'),
                    J = a(this), K = J.attr("data-indicators") || b.indicators;
